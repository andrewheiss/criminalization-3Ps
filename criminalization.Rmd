...
- **Remove prosecution from 3P index!**
...
```{r crim-effect}
model1 <- lm(p ~ p_lag + crim.level_lag + 
...
Preliminarily it looks like criminalization matters substantially. Moving from 0 to 1 (or 1 to 2) in the preceding year is associated with a 0.25 point increase in the overall 3P index and a 0.1 point increase in the protection index. The effect is positive for prevention, but not significant.
...
var.labs <- c("3P index (t − 1)", "Prevention (t − 1)", 
