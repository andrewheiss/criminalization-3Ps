...
# differences into account—the deflator for each country in 2010 is essentially
# 91.79. When there are differences, it's because of floating point issues
# (like, if there are tiny grants of $3, there aren't enough decimal points to
# get the fraction to 91.79). So we just take the median value of the deflator
